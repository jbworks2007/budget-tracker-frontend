...
import { modifyUserBudget } from "@/api/user-budget/modify-user-budget";
...
export default function UpdateBudgetModal({ isOpen, onClose, prevAmt }: ModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-xl">
        <h2 className="text-lg font-medium text-gray-900">Update Budget</h2>
